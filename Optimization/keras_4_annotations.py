...
if __name__ == "__main__":
    ...
    # ----------------------------------
    train_data_obj = X_y_dataHandler(ann_set=args.ann_set, include_negatives=0)
    train_data_obj.load_data_set(train_filename)
    # ----------------------------------
    devel_data_obj = X_y_dataHandler(ann_set=args.ann_set, include_negatives=0)
    devel_data_obj.load_data_set(devel_filename)
    # ----------------------------------
    test_data_obj = X_y_dataHandler(ann_set=args.ann_set, include_negatives=0)
