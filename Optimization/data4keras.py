...
class X_y_dataHandler:
    ...
    def __init__(self, ann_set, include_o_labels=0):
        ...
        self.include_o_labels = include_o_labels
    ...
    def make_numpy_arrays(self, X_dim_preset, y_dim_preset, padding_side='right'):
        ...
        if not self.include_o_labels:
            self.y_n_hot_np = np.delete(self.y_n_hot_np, self.o_label_id - 1, 1)
            self.y_max_value -= 1
